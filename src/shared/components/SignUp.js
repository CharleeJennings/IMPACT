...
function Review(props) {
	if (props.loading)
		return (
			<Grid container direction="column" alignContent="center" alignItems="center" justify="center" style={{marginTop: "50px"}}>
				<Grid item xs={12}>
		...
		return (
			<Typography container direction="column" alignContent="center" alignItems="flex-start" justify="flex-start" spacing={1} style={{padding: "20px"}}>
				<Grid item>
								...
								<Paper className={classes.paper}>
									<form
										...
										<SwipeableViews
											...
											<Grid container direction="column" alignItems="center" alignContent="center" className={classes.innerGrid}>
												<Grid item xs={12}>
													<TextField label="Firstname" onChange={updateField} name="firstname" />
												</Grid>
												<Grid item xs={12}>
											...
											<Grid container direction="column" alignItems="center" alignContent="center" className={classes.innerGrid}>
												<Grid item xs={6}>
													<TextField label="Email" onChange={updateField} name="email" />
												</Grid>
												<Grid item xs={6}>
													<TextField label="Confirm Email" onChange={updateField} name="emailC" />
												</Grid>
											</Grid>
											<Grid container direction="column" alignItems="center" alignContent="center" className={classes.innerGrid}>
												<Grid item xs={3}>
											...
											<Review firstname={form.firstname} lastname={form.lastname} email={form.email} birthday={date.toDateString()} loading={loading} />
										</SwipeableViews>
									</form>
								</Paper>
							</Grid>
